...
- 编译 PDF：`D:\BIGCHUANG\-\deliverables\national_award\latex\project_summary.pdf`

## 汇报材料

- 汇报 PPT：`D:\BIGCHUANG\-\deliverables\national_award\elderly_health_national_award.pptx`
...
> 当前材料、代码和内部评测已可复现；医生签字、真实老人/医生人因研究、带日期的外部 Curve V2 数据和独立外部风险队列仍需项目组在校内或合作机构完成，不能用演示数据替代。
