...
export const PERMISSION_MATRIX = Object.freeze({
  ...
  caregiver: ['read_authorized_health', 'write_authorized_intake', 'use_agent_for_authorized', 'manage_authorized_followups', 'view_authorized_interventions', 'record_authorized_intervention_adherence'],
  doctor: ['read_authorized_health', 'write_clinical_review', 'use_agent_for_authorized', 'view_clinical_evidence', 'view_authorized_interventions'],
